...
public sealed class OrderHub : Hub
{
    ...
    /// <summary>Subscribes the calling connection to one order's updates.</summary>
    ...
    /// <summary>Stops the calling connection following an order.</summary>
    ...
    /// <summary>Names the group carrying one order's updates.</summary>
